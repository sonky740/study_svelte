...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 41, 4, 1086);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 34, 2, 828);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$3, 35, 2, 847);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$3, 33, 0, 821);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 25, 6, 574);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (23:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 20, 2, 424);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$2, 21, 2, 440);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$2, 19, 0, 412);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (25:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(25:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 19, 4, 368);
    			attr_dev(h2, "class", "svelte-12wunlm");
    			add_location(h2, file$1, 20, 4, 389);
    			attr_dev(p, "class", "svelte-12wunlm");
    			add_location(p, file$1, 21, 4, 410);
    			add_location(div0, file$1, 18, 2, 358);
    			add_location(div1, file$1, 23, 2, 442);
    			attr_dev(div2, "class", "product svelte-12wunlm");
    			add_location(div2, file$1, 17, 0, 334);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
