...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 6, 0, 85);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(32:2) {#if member.isParent}",
    		ctx
    	});
    ...
    // (33:4) {#each member.children as child}
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(33:4) {#each member.children as child}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let t1;
    	let h1;
    	let t2_value = /*member*/ ctx[0].name + "";
    	let t2;
    	let t3;
    	let current;
    	let mounted;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 29, 2, 510);
    			add_location(h1, file$1, 30, 2, 557);
    			attr_dev(div, "class", "svelte-1111zfo");
    			toggle_class(div, "active", /*isActive*/ ctx[1]);
    			add_location(div, file$1, 28, 0, 477);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*member*/ 1) && t2_value !== (t2_value = /*member*/ ctx[0].name + "")) set_data_dev(t2, t2_value);
    ...
    // (58:2) {#each familyStructure as familyMember}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:2) {#each familyStructure as familyMember}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 46, 0, 1021);
    			add_location(button1, file, 49, 2, 1086);
    			attr_dev(div, "class", "svelte-ufz2tx");
    			add_location(div, file, 48, 0, 1077);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
