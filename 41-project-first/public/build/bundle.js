...
var app = (function () {
    ...
    const file$3 = "src\\components\\ui\\Header.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 6, 4, 72);
    			attr_dev(h2, "class", "svelte-wcfffe");
    			add_location(h2, file$2, 7, 4, 101);
    			attr_dev(p0, "class", "svelte-wcfffe");
    			add_location(p0, file$2, 8, 4, 133);
    			attr_dev(header, "class", "svelte-wcfffe");
    			add_location(header, file$2, 5, 2, 58);
    ...
    const file$1 = "src\\components\\meetups\\MeetupGrid.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 32, 0, 1001);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
