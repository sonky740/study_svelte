...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			if (default_slot) default_slot.c();
    			attr_dev(span, "class", "svelte-e308am");
    ...
    // (37:4) <Button       mode="outline"       color={!isFav && 'success'}       type="button"       on:click={() => dispatch('toggleFavorite', id)}       >
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(37:4) <Button       mode=\\\"outline\\\"       color={!isFav && 'success'}       type=\\\"button\\\"       on:click={() => dispatch('toggleFavorite', id)}       >",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*isFav*/ 128) button1_changes.color = !/*isFav*/ ctx[7] && 'success';
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-3r750p");
    			toggle_class(input, "invalid", !/*valid*/ ctx[6] && /*touched*/ ctx[8]);
    			add_location(input, file$3, 25, 4, 548);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-3r750p");
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "error-message svelte-3r750p");
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-3r750p");
    			add_location(label_1, file$3, 14, 2, 279);
    			attr_dev(div, "class", "form-control svelte-3r750p");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 13, 0, 265);
    			attr_dev(h1, "class", "svelte-rj5ywu");
    			add_location(h1, file$2, 15, 2, 359);
    			attr_dev(div0, "class", "content svelte-rj5ywu");
    			add_location(div0, file$2, 16, 2, 379);
    			attr_dev(footer, "class", "svelte-rj5ywu");
    			add_location(footer, file$2, 19, 2, 428);
    			attr_dev(div1, "class", "modal svelte-rj5ywu");
    			add_location(div1, file$2, 14, 0, 336);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { title = 'Edit Meetup Data' } = $$props;
    	const dispatch = createEventDispatcher();
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$1, 47, 2, 1137);
    		},
    		m: function mount(target, anchor) {
    ...
    // (100:4) <Button type="button" on:click={() => dispatch('cancel')}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(100:4) <Button type=\\\"button\\\" on:click={() => dispatch('cancel')}>",
    		ctx
    	});
    ...
    // (101:4) <Button        type="submit"        mode="outline"        disabled={!formIsValid}        on:click={submitForm}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(101:4) <Button        type=\\\"submit\\\"        mode=\\\"outline\\\"        disabled={!formIsValid}        on:click={submitForm}>",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 98, 2, 2594);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*meetups*/ 1) editmeetup_changes.meetups = /*meetups*/ ctx[0];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "meetup-controls svelte-yryaqp");
    			add_location(div, file, 68, 2, 2125);
    			attr_dev(main, "class", "svelte-yryaqp");
    			add_location(main, file, 67, 0, 2116);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
